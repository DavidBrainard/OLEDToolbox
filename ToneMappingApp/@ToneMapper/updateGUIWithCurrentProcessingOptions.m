function updateGUIWithCurrentProcessingOptions(obj)
    ...
    set(obj.GUI.subMenu64, 'Label', sprintf('Display max luminance limiting factor (currently: %2.0f%% of max luminance) ...', obj.processingOptions.displayMaxLuminanceLimitingFactor*100));
end

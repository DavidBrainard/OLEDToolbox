...
mex exrread.cpp  -lIlmImf -lIex -lImath -lHalf -I/opt/local/include/OpenEXR -L/opt/local/lib
mex exrwrite.cpp -lIlmImf -lIex -lImath -lHalf -I/opt/local/include/OpenEXR -L/opt/local/lib
mex exrinfo.cpp  -lIlmImf -lIex -lImath -lHalf -I/opt/local/include/OpenEXR -L/opt/local/lib
:q!

function convertOverUnderToSideBySideParameters(obj, win, leftOffset, leftScale, rightOffset, rightScale)
    ...
    if ~ismember(winfo.StereoMode, [2,3])
        ...
        fprintf(2,'SetStereoSideBySideParameters: Info: Provided onscreen window is not in appropriate mode. Call ignored.\n');
        return;
    end

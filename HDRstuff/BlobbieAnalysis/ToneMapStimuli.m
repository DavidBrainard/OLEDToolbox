function ToneMapStimuli
    ...
    clipSceneLumincanceLevels =  [20 round(inputEnsembleLuminanceRange(2))]; % ]; % round(inputEnsembleLuminanceRange(2)); %round(sum(maxRealizableLuminanceRGBgunsOLED))%4000;  % this is in Cd/m2
    normalizationMode = 0;

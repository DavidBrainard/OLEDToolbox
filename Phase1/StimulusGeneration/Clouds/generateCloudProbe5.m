function generateCloudProbe5

    stimFileName = 'PixelOLEDprobes5.mat';
    ...
    for exponentOfOneOverFIndex = 1:numel(stimParams.exponentOfOneOverFArray)
        ...
        for oriBiasIndex = 1:numel(stimParams.oriBiasArray)
            ...
            for orientationIndex = 1:numel(stimParams.orientationsArray)
                ...
                [imageSequence, stimParams.variants] = generateMovingCloudSequence(exponentOfOneOverF, oriBias, orientation,stimParams, envelope, pixelSize);
...
function [imageSequence, variants] = generateMovingCloudSequence(exponentOfOneOverF, oriBias, orientation, stimParams, envelope, pixelSize)
